 ...
 */
public class AntennaSpecStopTriggerType extends UnsignedByte
    ...
    Logger logger = Logger.getLogger(AntennaSpecStopTriggerType.class);

    public AntennaSpecStopTriggerType() {
        super(0);
    }
     ...
     */
    public AntennaSpecStopTriggerType(int value) {
        super(value);
    ...
    */
    public AntennaSpecStopTriggerType(final Element element) {
    ...
    */
    public AntennaSpecStopTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AntennaSpecStopTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AntennaSpecStopTriggerType must convert BigInteger " + value +
