 ...
 */
public class SelectSpecStartTriggerType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Null = 0;
    public static final int Immediate = 1;
    public static final int Periodic = 2;
    public static final int GPI = 3;
    Logger logger = Logger.getLogger(SelectSpecStartTriggerType.class);

    public SelectSpecStartTriggerType() {
        super(0);
    }
     ...
     */
    public SelectSpecStartTriggerType(int value) {
        super(value);
    ...
    */
    public SelectSpecStartTriggerType(final Element element) {
    ...
    */
    public SelectSpecStartTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public SelectSpecStartTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("SelectSpecStartTriggerType must convert BigInteger " + value +
