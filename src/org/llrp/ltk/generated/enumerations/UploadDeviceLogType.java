...
/**
 * UploadDeviceLogType is Enumeration of Type UnsignedByte
 */
public class UploadDeviceLogType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int According_To_Sequence = 0;
    public static final int According_To_Timestamp = 1;
    Logger logger = Logger.getLogger(UploadDeviceLogType.class);

    public UploadDeviceLogType() {
        super(0);
    }

    /**
     * Create new UploadDeviceLogType by passing integer value.
     *
     ...
     */
    public UploadDeviceLogType(int value) {
        super(value);
    ...
    /**
    * Create new UploadDeviceLogType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public UploadDeviceLogType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new UploadDeviceLogType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public UploadDeviceLogType(final String name) {
        if (!isValidName(name)) {
    ...
    /**
     * Create new UploadDeviceLogType by passing LLRPBitList.
     *
     * @throws IllegalArgumentException
     ...
     */
    public UploadDeviceLogType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("According_To_Sequence")) {
            return 0;
        }

        if (name.equalsIgnoreCase("According_To_Timestamp")) {
            return 1;
        }
    ...
    public final String getName(final int value) {
        if (0 == value) {
            return "According_To_Sequence";
        }

        if (1 == value) {
            return "According_To_Timestamp";
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("According_To_Sequence")) {
            return true;
        }

        if (name.equals("According_To_Timestamp")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("UploadDeviceLogType must convert BigInteger " + value +
