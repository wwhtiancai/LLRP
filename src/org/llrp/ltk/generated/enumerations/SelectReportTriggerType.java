 ...
 */
public class SelectReportTriggerType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int None = 0;
    public static final int Upon_N_Tags_Or_End_Of_AntennaSpec = 1;
    public static final int Upon_N_Tags_Or_End_Of_SelectSpec = 2;
    public static final int No_ROReport = 3;
    Logger logger = Logger.getLogger(SelectReportTriggerType.class);

    public SelectReportTriggerType() {
        super(0);
    }
     ...
     */
    public SelectReportTriggerType(int value) {
        super(value);
    ...
    */
    public SelectReportTriggerType(final Element element) {
    ...
    */
    public SelectReportTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public SelectReportTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Upon_N_Tags_Or_End_Of_AntennaSpec")) {
            return 1;
        }

        if (name.equalsIgnoreCase("Upon_N_Tags_Or_End_Of_SelectSpec")) {
            return 2;
        }

        if (name.equalsIgnoreCase("No_ROReport")) {
            return 3;
        }
    ...
    public final String getName(final int value) {
        ...
        if (1 == value) {
            return "Upon_N_Tags_Or_End_Of_AntennaSpec";
        }

        if (2 == value) {
            return "Upon_N_Tags_Or_End_Of_SelectSpec";
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Upon_N_Tags_Or_End_Of_AntennaSpec")) {
            return true;
        }
        if (name.equals("Upon_N_Tags_Or_End_Of_SelectSpec")) {
            return true;
        }

        if (name.equals("No_ROReport")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("SelectReportTriggerType must convert BigInteger " + value +
