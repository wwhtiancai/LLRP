 ...
 */
public class AntennaStatusEventType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Antenna_Disconnected = 0;
    public static final int Antenna_Connected = 1;
    Logger logger = Logger.getLogger(AntennaStatusEventType.class);

    public AntennaStatusEventType() {
        super(0);
    }
     ...
     */
    public AntennaStatusEventType(int value) {
        super(value);
    ...
    */
    public AntennaStatusEventType(final Element element) {
    ...
    */
    public AntennaStatusEventType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AntennaStatusEventType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AntennaStatusEventType must convert BigInteger " + value +
