...
/**
 * VersionType is Enumeration of Type UnsignedByte
 */
public class VersionType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Device_Boot = 0;
    public static final int Device_Sys = 1;
    public static final int Security_Module_Sys = 2;
    public static final int Security_Chip_Sys = 3;
    Logger logger = Logger.getLogger(VersionType.class);
    ...
    */
    public VersionType(final Element element) {
    ...
    */
    public VersionType(final String name) {
        if (!isValidName(name)) {
    ...
    /**
     * Create new VersionType by passing LLRPBitList.
     *
     * @throws IllegalArgumentException
     ...
     */
    public VersionType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Device_Boot")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Device_Sys")) {
            return 1;
        }
        
        if (name.equalsIgnoreCase("Security_Module_Sys")) {
            return 2;
        }
        
        if (name.equalsIgnoreCase("Security_Chip_Sys")) {
            return 3;
        }
    ...
    public final String getName(final int value) {
        ...
        if (2 == value) {
            return "Security_Module_Sys";
        }

        if (3 == value) {
            return "Security_Chip_Sys";
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Device_Boot")) {
            return true;
        }

        if (name.equals("Device_Sys")) {
            return true;
        }
        
        if (name.equals("Security_Module_Sys")) {
            return true;
        }

        if (name.equals("Security_Chip_Sys")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("VersionType must convert BigInteger " + value +
