 ...
 */
public class HbTargetTagMatchType extends Bit
    implements LLRPEnumeration {
    public static final int Forward = 0;
    public static final int Reverse = 1;
    Logger logger = Logger.getLogger(HbTargetTagMatchType.class);

    public HbTargetTagMatchType() {
        super(0);
    }
     ...
     */
    public HbTargetTagMatchType(int value) {
        super(value);
    ...
    */
    public HbTargetTagMatchType(final Element element) {
    ...
    */
    public HbTargetTagMatchType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public HbTargetTagMatchType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("HbTargetTagMatchType must convert BigInteger " + value +
