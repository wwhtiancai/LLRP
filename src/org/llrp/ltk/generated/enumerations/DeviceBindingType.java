 ...
 */
public class DeviceBindingType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Binding = 0;
    public static final int ReBinding = 1;
    Logger logger = Logger.getLogger(DeviceBindingType.class);

    public DeviceBindingType() {
        super(0);
    }
     ...
     */
    public DeviceBindingType(int value) {
        super(value);
    ...
    */
    public DeviceBindingType(final Element element) {
    ...
    */
    public DeviceBindingType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public DeviceBindingType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("ReBinding")) {
            return 1;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("DeviceBindingType must convert BigInteger " + value +
