 ...
 */
public class ReaderLocationType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Location_GPS = 0;
    public static final int Location_BDS = 1;
    Logger logger = Logger.getLogger(ReaderLocationType.class);

    public ReaderLocationType() {
        super(0);
    }
     ...
     */
    public ReaderLocationType(int value) {
        super(value);
    ...
    */
    public ReaderLocationType(final Element element) {
    ...
    */
    public ReaderLocationType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ReaderLocationType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Location_GPS")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Location_BDS")) {
            return 1;
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Location_GPS")) {
            return true;
        }

        if (name.equals("Location_BDS")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ReaderLocationType must convert BigInteger " + value +
