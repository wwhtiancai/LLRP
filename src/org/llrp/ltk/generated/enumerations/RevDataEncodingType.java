 ...
 */
public class RevDataEncodingType extends UnsignedByte implements LLRPEnumeration {
    public static final int FM0 = 0;
    public static final int Miller = 1;
    public static final int Miller4 = 2;
    public static final int Miller8 = 3;
    Logger logger = Logger.getLogger(RevDataEncodingType.class);

    public RevDataEncodingType() {
        super(0);
    }
     ...
     */
    public RevDataEncodingType(int value) {
        super(value);
    ...
    */
    public RevDataEncodingType(final Element element) {
    ...
    */
    public RevDataEncodingType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public RevDataEncodingType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("FM0")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Miller")) {
            return 1;
        }
        
        if (name.equalsIgnoreCase("Miller4")) {
            return 2;
        }

        if (name.equalsIgnoreCase("Miller8")) {
            return 3;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Miller")) {
            return true;
        }
        
        if (name.equals("Miller4")) {
            return true;
        }

        if (name.equals("Miller8")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("RevDataEncodingType must convert BigInteger " + value +
