 ...
 */
public class AlarmRestoreType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Auto = 0;
    public static final int Sync = 1;
    public static final int Manual = 2;
    Logger logger = Logger.getLogger(AlarmRestoreType.class);

    public AlarmRestoreType() {
        super(0);
    }
     ...
     */
    public AlarmRestoreType(int value) {
        super(value);
    ...
    */
    public AlarmRestoreType(final Element element) {
    ...
    */
    public AlarmRestoreType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AlarmRestoreType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AlarmRestoreType must convert BigInteger " + value +
