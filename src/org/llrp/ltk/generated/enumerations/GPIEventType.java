 ...
 */
public class GPIEventType extends UnsignedByte implements LLRPEnumeration {
    public static final int Falling = 0;
    public static final int Rising = 1;
    Logger logger = Logger.getLogger(GPIEventType.class);
    ...
    */
    public GPIEventType(final Element element) {
    ...
    */
    public GPIEventType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public GPIEventType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Falling")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Rising")) {
            return 1;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("GPIEventType must convert BigInteger " + value +
