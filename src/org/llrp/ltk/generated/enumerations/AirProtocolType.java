 ...
 */
public class AirProtocolType extends UnsignedByte implements LLRPEnumeration {
    public static final int Hb = 0;
    Logger logger = Logger.getLogger(AirProtocolType.class);

    public AirProtocolType() {
        super(0);
    }
     ...
     */
    public AirProtocolType(int value) {
        super(value);
    ...
    */
    public AirProtocolType(final Element element) {
    ...
    */
    public AirProtocolType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AirProtocolType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AirProtocolType must convert BigInteger " + value +
