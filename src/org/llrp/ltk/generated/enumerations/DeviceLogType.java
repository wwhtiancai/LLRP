 ...
 */
public class DeviceLogType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Device_Failure = 0;
    public static final int Failure_Recovery = 1;
    public static final int Running_Log = 2;
    Logger logger = Logger.getLogger(DeviceLogType.class);

    public DeviceLogType() {
        super(0);
    }
     ...
     */
    public DeviceLogType(int value) {
        super(value);
    ...
    */
    public DeviceLogType(final Element element) {
    ...
    */
    public DeviceLogType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public DeviceLogType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Device_Failure")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Failure_Recovery")) {
            return 1;
        }
        
        if (name.equalsIgnoreCase("Running_Log")) {
            return 2;
        }
        return -1;
    }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Device_Failure")) {
            return true;
        }

        if (name.equals("Failure_Recovery")) {
            return true;
        }
        
        if (name.equals("Running_Log")) {
            return true;
        }
        return false;
    }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("DeviceLogType must convert BigInteger " + value +
