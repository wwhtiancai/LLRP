 ...
 */
public class RfSpecSelectType extends UnsignedByte implements LLRPEnumeration {
    public static final int Inventory = 0;
    public static final int Read = 1;
    Logger logger = Logger.getLogger(RfSpecSelectType.class);

    public RfSpecSelectType() {
        super(0);
    }
     ...
     */
    public RfSpecSelectType(int value) {
        super(value);
    ...
    */
    public RfSpecSelectType(final Element element) {
    ...
    */
    public RfSpecSelectType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public RfSpecSelectType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("RfSpecSelectType must convert BigInteger " + value +
