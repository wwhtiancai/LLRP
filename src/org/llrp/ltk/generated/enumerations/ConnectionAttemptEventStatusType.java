 ...
 */
public class ConnectionAttemptEventStatusType extends UnsignedShort
    implements LLRPEnumeration {
    public static final int Success = 0;
    public static final int Failed_A_Device_Initiated_Connection_Already_Exists = 1;
    ...
    public static final int Failed_Reason_Other_Than_A_Connection_Already_Exists =
        3;
    Logger logger = Logger.getLogger(ConnectionAttemptEventStatusType.class);

    public ConnectionAttemptEventStatusType() {
        super(0);
    }
     ...
     */
    public ConnectionAttemptEventStatusType(int value) {
        super(value);
    ...
    */
    public ConnectionAttemptEventStatusType(final Element element) {
    ...
    */
    public ConnectionAttemptEventStatusType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ConnectionAttemptEventStatusType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase(
                    "Failed_A_Device_Initiated_Connection_Already_Exists")) {
            return 1;
        }
    ...
    public final String getName(final int value) {
        ...
        if (1 == value) {
            return "Failed_A_Device_Initiated_Connection_Already_Exists";
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Failed_A_Device_Initiated_Connection_Already_Exists")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ConnectionAttemptEventStatusType must convert BigInteger " +
