 ...
 */
public class VersionDownloadServerType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Ftp = 0;
    public static final int Tftp = 1;
    Logger logger = Logger.getLogger(VersionDownloadServerType.class);

    public VersionDownloadServerType() {
        super(0);
    }
     ...
     */
    public VersionDownloadServerType(int value) {
        super(value);
    ...
    */
    public VersionDownloadServerType(final Element element) {
    ...
    */
    public VersionDownloadServerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public VersionDownloadServerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("VersionDownloadServerType must convert BigInteger " + value +
