 ...
 */
public class UploadTagLogType extends UnsignedByte
    ...
    Logger logger = Logger.getLogger(UploadTagLogType.class);

    public UploadTagLogType() {
        super(0);
    }
     ...
     */
    public UploadTagLogType(int value) {
        super(value);
    ...
    */
    public UploadTagLogType(final Element element) {
    ...
    */
    public UploadTagLogType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public UploadTagLogType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("UploadTagLogType must convert BigInteger " + value +
