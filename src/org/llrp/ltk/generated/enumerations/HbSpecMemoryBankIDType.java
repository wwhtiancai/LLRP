 ...
 */
public class HbSpecMemoryBankIDType extends UnsignedByte implements LLRPEnumeration {
    ...
    Logger logger = Logger.getLogger(HbSpecMemoryBankIDType.class);

    public HbSpecMemoryBankIDType() {
        super(0);
    }
     ...
     */
    public HbSpecMemoryBankIDType(int value) {
        super(value);
    ...
    */
    public HbSpecMemoryBankIDType(final Element element) {
    ...
    */
    public HbSpecMemoryBankIDType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public HbSpecMemoryBankIDType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("User_0")) {
            return 0;
        }

        if (name.equalsIgnoreCase("User_1")) {
            return 1;
        }

        if (name.equalsIgnoreCase("User_2")) {
            return 2;
        }
        if (name.equalsIgnoreCase("User_3")) {
            return 3;
        }

        if (name.equalsIgnoreCase("User_4")) {
            return 4;
        }

        if (name.equalsIgnoreCase("User_5")) {
            return 5;
        }
        return -1;
    }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("User_2")) {
            return true;
        }
        
        if (name.equals("User_3")) {
            return true;
        }

        if (name.equals("User_4")) {
            return true;
        }

        if (name.equals("User_5")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("HbSpecMemoryBankIDType must convert BigInteger " + value +
