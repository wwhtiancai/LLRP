 ...
 */
public class TcpLinkCommMode extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Client = 0;
    public static final int Server = 1;
    public static final int Mix = 2;
    Logger logger = Logger.getLogger(TcpLinkCommMode.class);

    public TcpLinkCommMode() {
        super(0);
    }
     ...
     */
    public TcpLinkCommMode(int value) {
        super(value);
    ...
    */
    public TcpLinkCommMode(final Element element) {
    ...
    */
    public TcpLinkCommMode(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public TcpLinkCommMode(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("TcpLinkCommMode must convert BigInteger " + value +
