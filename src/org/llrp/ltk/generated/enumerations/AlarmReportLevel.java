 ...
 */
public class AlarmReportLevel extends UnsignedByte
    ...
    Logger logger = Logger.getLogger(AlarmReportLevel.class);

    public AlarmReportLevel() {
        super(0);
    }
     ...
     */
    public AlarmReportLevel(int value) {
        super(value);
    ...
    */
    public AlarmReportLevel(final Element element) {
    ...
    */
    public AlarmReportLevel(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AlarmReportLevel(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Serious")) {
            return 1;
        }
        ...
        if (name.equalsIgnoreCase("Slight")) {
            return 3;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AlarmReportLevel must convert BigInteger " + value +
