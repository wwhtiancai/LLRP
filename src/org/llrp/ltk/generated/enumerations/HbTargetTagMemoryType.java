 ...
 */
public class HbTargetTagMemoryType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Tid = 0;
    public static final int User = 1;
    Logger logger = Logger.getLogger(HbTargetTagMemoryType.class);

    public HbTargetTagMemoryType() {
        super(0);
    }
     ...
     */
    public HbTargetTagMemoryType(int value) {
        super(value);
    ...
    */
    public HbTargetTagMemoryType(final Element element) {
    ...
    */
    public HbTargetTagMemoryType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public HbTargetTagMemoryType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("HbTargetTagMemoryType must convert BigInteger " + value +
