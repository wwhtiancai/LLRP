 ...
 */
public class IPAddressVersion extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Ipv4 = 0;
    public static final int Ipv6 = 1;
    Logger logger = Logger.getLogger(IPAddressVersion.class);
     ...
     */
    public IPAddressVersion(int value) {
        super(value);
    ...
    */
    public IPAddressVersion(final Element element) {
    ...
    */
    public IPAddressVersion(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public IPAddressVersion(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("IPAddressVersion must convert BigInteger " + value +
