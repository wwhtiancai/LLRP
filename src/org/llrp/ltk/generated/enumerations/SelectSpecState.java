 ...
 */
public class SelectSpecState extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Disabled = 0;
    public static final int Inactive = 1;
    public static final int Active = 2;
    Logger logger = Logger.getLogger(SelectSpecState.class);

    public SelectSpecState() {
        super(0);
    }
     ...
     */
    public SelectSpecState(int value) {
        super(value);
    ...
    */
    public SelectSpecState(final Element element) {
    ...
    */
    public SelectSpecState(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public SelectSpecState(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("SelectSpecState must convert BigInteger " + value +
