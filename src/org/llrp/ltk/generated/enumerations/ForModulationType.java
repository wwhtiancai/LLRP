 ...
 */
public class ForModulationType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int SSB_ASK = 0;
    public static final int DSB_ASK = 1;
    Logger logger = Logger.getLogger(ForModulationType.class);

    public ForModulationType() {
        super(0);
    }
     ...
     */
    public ForModulationType(int value) {
        super(value);
    ...
    */
    public ForModulationType(final Element element) {
    ...
    */
    public ForModulationType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ForModulationType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ForModulationType must convert BigInteger " + value +
