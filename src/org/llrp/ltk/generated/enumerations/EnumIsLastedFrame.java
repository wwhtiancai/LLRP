 ...
 */
public class EnumIsLastedFrame extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Continue = 0;
    public static final int End = 1;
    Logger logger = Logger.getLogger(EnumIsLastedFrame.class);

    public EnumIsLastedFrame() {
        super(0);
    }
     ...
     */
    public EnumIsLastedFrame(int value) {
        super(value);
    ...
    */
    public EnumIsLastedFrame(final Element element) {
    ...
    */
    public EnumIsLastedFrame(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public EnumIsLastedFrame(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("EnumIsLastedFrame must convert BigInteger " + value +
