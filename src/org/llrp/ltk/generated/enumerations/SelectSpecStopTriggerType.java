 ...
 */
public class SelectSpecStopTriggerType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Null = 0;
    public static final int Duration = 1;
    public static final int GPI_With_Timeout = 2;
    Logger logger = Logger.getLogger(SelectSpecStopTriggerType.class);

    public SelectSpecStopTriggerType() {
        super(0);
    }
     ...
     */
    public SelectSpecStopTriggerType(int value) {
        super(value);
    ...
    */
    public SelectSpecStopTriggerType(final Element element) {
    ...
    */
    public SelectSpecStopTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public SelectSpecStopTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("SelectSpecStopTriggerType must convert BigInteger " + value +
