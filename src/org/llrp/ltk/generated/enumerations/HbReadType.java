 ...
 */
public class HbReadType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Read_As_Length = 0;
    public static final int Read_As_Area_Type = 1;
    Logger logger = Logger.getLogger(HbReadType.class);
    ...
    */
    public HbReadType(final Element element) {
    ...
    */
    public HbReadType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public HbReadType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Read_As_Length")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Read_As_Area_Type")) {
            return 1;
        }
    ...
    public final String getName(final int value) {
        if (0 == value) {
            return "Read_As_Length";
        }

        if (1 == value) {
            return "Read_As_Area_Type";
        }
        return "";
    }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Read_As_Length")) {
            return true;
        }

        if (name.equals("Read_As_Area_Type")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ReadType must convert BigInteger " + value +
