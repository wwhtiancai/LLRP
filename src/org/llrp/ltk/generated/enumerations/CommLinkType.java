 ...
 */
public class CommLinkType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Tcp = 0;
    public static final int Rs232 = 1;
    public static final int Rs485 = 2;
    public static final int Http = 3;
    Logger logger = Logger.getLogger(CommLinkType.class);
    ...
    */
    public CommLinkType(final Element element) {
    ...
    */
    public CommLinkType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public CommLinkType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Rs232")) {
            return true;
        }

        if (name.equals("Rs485")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("CommLinkType must convert BigInteger " +
