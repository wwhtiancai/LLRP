 ...
 */
public class SelectSpecEventType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Start_Of_SelectSpec = 0;
    public static final int End_Of_SelectSpec = 1;
    public static final int Preemption_Of_SelectSpec = 2;
    Logger logger = Logger.getLogger(SelectSpecEventType.class);

    public SelectSpecEventType() {
        super(0);
    }
     ...
     */
    public SelectSpecEventType(int value) {
        super(value);
    ...
    */
    public SelectSpecEventType(final Element element) {
    ...
    */
    public SelectSpecEventType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public SelectSpecEventType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Start_Of_SelectSpec")) {
            return 0;
        }

        if (name.equalsIgnoreCase("End_Of_SelectSpec")) {
            return 1;
        }

        if (name.equalsIgnoreCase("Preemption_Of_SelectSpec")) {
            return 2;
        }
        return -1;
    }
    ...
    public final String getName(final int value) {
        if (0 == value) {
            return "Start_Of_SelectSpec";
        }

        if (1 == value) {
            return "End_Of_SelectSpec";
        }
        
        if (2 == value) {
            return "Preemption_Of_SelectSpec";
        }
        return "";
    }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Start_Of_SelectSpec")) {
            return true;
        }

        if (name.equals("End_Of_SelectSpec")) {
            return true;
        }

        if (name.equals("Preemption_Of_SelectSpec")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("SelectSpecEventType must convert BigInteger " + value +
