 ...
 */
public class HbBankType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Bottom_Half = 0;
    public static final int Upper_Half = 1;
    public static final int Full = 2;
    Logger logger = Logger.getLogger(HbBankType.class);
    ...
    */
    public HbBankType(final Element element) {
    ...
    */
    public HbBankType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public HbBankType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Bottom_Half")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Upper_Half")) {
            return 1;
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Bottom_Half")) {
            return true;
        }

        if (name.equals("Upper_Half")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("BankType must convert BigInteger " + value +
