...
See also
      .
 */
public class SelectSpecID extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(501);
    private static final Logger LOGGER = Logger.getLogger(SelectSpecID.class);
     ...
     */
    public SelectSpecID(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public SelectSpecID(Element element) throws InvalidLLRPMessageException {
        decodeXML(element);
    }
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (selectSpecID == null) {
            ...
            throw new MissingParameterException(
                " selectSpecID not set  for Parameter of Type SelectSpecID");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "SelectSpecID has unknown element " +
