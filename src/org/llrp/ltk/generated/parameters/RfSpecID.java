...
See also
      .
 */
public class RfSpecID extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(503);
    private static final Logger LOGGER = Logger.getLogger(RfSpecID.class);
     ...
     */
    public RfSpecID(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public RfSpecID(Element element) throws InvalidLLRPMessageException {
        decodeXML(element);
    }
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (rfSpecID == null) {
            ...
            throw new MissingParameterException(
                " rfSpecID not set  for Parameter of Type RfSpecID");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "RfSpecID has unknown element " +
