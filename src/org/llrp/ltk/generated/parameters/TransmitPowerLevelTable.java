...
See also
      .
 */
public class TransmitPowerLevelTable extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(358);
    private static final Logger LOGGER = Logger.getLogger(TransmitPowerLevelTable.class);
     ...
     */
    public TransmitPowerLevelTable() {
    }
     ...
     */
    public TransmitPowerLevelTable(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public TransmitPowerLevelTable(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (index == null) {
            ...
            throw new MissingParameterException(
                " index not set  for Parameter of Type TransmitPowerLevelTable");
        }
        ...
        if (transmitPowerValue == null) {
            ...
            throw new MissingParameterException(
                " transmitPowerValue not set  for Parameter of Type TransmitPowerLevelTable");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "TransmitPowerLevelTable has unknown element " +
    ...
    */
    public String getName() {
        return "TransmitPowerLevelTable";
    }
    ...
    */
    public String toString() {
        String result = "TransmitPowerLevelTable: ";
        result += ", index: ";
        result += index;
