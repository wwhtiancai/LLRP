...
public class PerAntennaAirProtocol extends TLVParameter {
    ...
    */
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (protocolIDs == null) {
            LOGGER.warn(" protocolIDs not set");
            throw new MissingParameterException(
                " protocolIDs not set  for Parameter of Type PerAntennaAirProtocol");
        }

        resultBits.append(protocolIDs.encodeBinary());
    ...
    */
    public Content encodeXML(String name, Namespace ns) {
        ...
        if (protocolIDs == null) {
            LOGGER.warn(" protocolIDs not set");
            throw new MissingParameterException(" protocolIDs not set");
        } else {
            element.addContent(protocolIDs.encodeXML("ProtocolIDs", ns));
        }
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary) {
        ...
        protocolIDs = new UnsignedByteArray(binary.subList(position, tempLength));
        position += tempLength;
        ...
        if ((tempLength % 8) > 0) {
            ...
            LOGGER.info("padding needed for protocolIDs ");
        }
    }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        temp = element.getChild("ProtocolIDs", ns);

        if (temp != null) {
            protocolIDs = new UnsignedByteArray(temp);
        }

        element.removeChild("ProtocolIDs", ns);
    ...
    */
    ...
    /**
    * set   protocolIDs of type UnsignedByteArray .
    * @param   protocolIDs to be set
    */
    public void setProtocolIDs(final UnsignedByteArray protocolIDs) {
    ...
    */
    ...
    /**
    * get   protocolIDs of type UnsignedByteArray.
    * @return   type UnsignedByteArray to be set
    */
    public UnsignedByteArray getProtocolIDs() {
