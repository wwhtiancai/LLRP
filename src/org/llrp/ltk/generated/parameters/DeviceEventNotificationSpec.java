...
See also
      .
 */
public class DeviceEventNotificationSpec extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(660);
    private static final Logger LOGGER = Logger.getLogger(DeviceEventNotificationSpec.class);
    protected List<EventNotificationState> eventNotificationStateList = new LinkedList<EventNotificationState>();

    /**
     * empty constructor to create new parameter.
     */
    public DeviceEventNotificationSpec() {
    }
     ...
     */
    public DeviceEventNotificationSpec(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public DeviceEventNotificationSpec(Element element)
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary) {
        ...
        if (eventNotificationStateList.isEmpty()) {
            ...
            throw new MissingParameterException(
                "DeviceEventNotificationSpec misses non optional parameter of type EventNotificationState");
        }
    }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if ((tempList == null) || tempList.isEmpty()) {
            LOGGER.warn(
                "DeviceEventNotificationSpec misses non optional parameter of type eventNotificationStateList");
            throw new MissingParameterException(
                "DeviceEventNotificationSpec misses non optional parameter of type eventNotificationStateList");
        } else {
        ...
        if (element.getChildren().size() > 0) {
            String message = "DeviceEventNotificationSpec has unknown element " +
    ...
    */
    public String toString() {
        String result = "DeviceEventNotificationSpec: ";
