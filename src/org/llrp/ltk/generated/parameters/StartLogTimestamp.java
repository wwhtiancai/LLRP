...
See also
      .
 */
public class StartLogTimestamp extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(621);
    private static final Logger LOGGER = Logger.getLogger(StartLogTimestamp.class);
    protected UnsignedLong microseconds;

    /**
     * empty constructor to create new parameter.
     */
    public StartLogTimestamp() {
    }
     ...
     */
    public StartLogTimestamp(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public StartLogTimestamp(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (microseconds == null) {
            ...
            throw new MissingParameterException(
                " microseconds not set  for Parameter of Type StartLogTimestamp");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "StartLogTimestamp has unknown element " +
    ...
    */
    public String toString() {
        String result = "StartLogTimestamp: ";
        result += ", microseconds: ";
        result += microseconds;
