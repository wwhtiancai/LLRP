...
public class GPIEvent extends TLVParameter {
    ...
    protected UnsignedByte gPIPortNumber;
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary) {
        ...
        SignedShort type;
        int fieldCount;
        gPIPortNumber = new UnsignedByte(binary.subList(position,
                    UnsignedByte.length()));
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (temp != null) {
            gPIPortNumber = new UnsignedByte(temp);
        }
    ...
    //setters
    /**
    * set   gPIPortNumber of type UnsignedByte .
    * @param   gPIPortNumber to be set
    */
    public void setGPIPortNumber(final UnsignedByte gPIPortNumber) {
    ...
    */
    ...
    //getters
    /**
    * get   gPIPortNumber of type UnsignedByte.
    * @return   type UnsignedByte to be set
    */
    public UnsignedByte getGPIPortNumber() {
