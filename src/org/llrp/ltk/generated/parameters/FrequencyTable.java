...
See also
      .
 */
public class FrequencyTable extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(360);
    private static final Logger LOGGER = Logger.getLogger(FrequencyTable.class);
     ...
     */
    public FrequencyTable(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public FrequencyTable(Element element) throws InvalidLLRPMessageException {
        decodeXML(element);
    }
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (index == null) {
            ...
            throw new MissingParameterException(
                " index not set  for Parameter of Type FrequencyTable");
        }
        ...
        if (frequency == null) {
            ...
            throw new MissingParameterException(
                " frequency not set  for Parameter of Type FrequencyTable");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "FrequencyTable has unknown element " +
