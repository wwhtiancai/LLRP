...
See also
      .
 */
public class HbWriteSpecResult extends TLVParameter implements AccessSpecResult {
    public static final SignedShort TYPENUM = new SignedShort(513);
    private static final Logger LOGGER = Logger.getLogger(HbWriteSpecResult.class);
     ...
     */
    public HbWriteSpecResult(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public HbWriteSpecResult(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (result == null) {
            ...
            throw new MissingParameterException(
                " result not set  for Parameter of Type HbWriteSpecResult");
        }
        ...
        if (resultDescription == null) {
            ...
            throw new MissingParameterException(
                " resultDescription not set  for Parameter of Type HbWriteSpecResult");
        }
        ...
        if (opSpecID == null) {
            ...
            throw new MissingParameterException(
                " opSpecID not set  for Parameter of Type HbWriteSpecResult");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "HbWriteSpecResult has unknown element " +
    ...
    */
    public String toString() {
        String result = "HbWriteSpecResult: ";
        result += ", result: ";
        result += result;
