...
import org.llrp.ltk.generated.enumerations.AntennaStatusEventType;
...
See also
      .
 */
public class AntennaStatusEvent extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(305);
    private static final Logger LOGGER = Logger.getLogger(AntennaStatusEvent.class);
    protected AntennaStatusEventType eventType;
    protected UnsignedByte antennaID;

    /**
     * empty constructor to create new parameter.
     */
    public AntennaStatusEvent() {
    }
     ...
     */
    public AntennaStatusEvent(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public AntennaStatusEvent(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (eventType == null) {
            ...
            throw new MissingParameterException(
                " eventType not set  for Parameter of Type AntennaStatusEvent");
        }
        ...
        if (antennaID == null) {
            ...
            throw new MissingParameterException(
                " antennaID not set  for Parameter of Type AntennaStatusEvent");
        }
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary) {
        ...
        SignedShort type;
        int fieldCount;
        eventType = new AntennaStatusEventType(binary.subList(position,
                    AntennaStatusEventType.length()));
        position += AntennaStatusEventType.length();
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (temp != null) {
            eventType = new AntennaStatusEventType(temp);
        }
        ...
        if (element.getChildren().size() > 0) {
            String message = "AntennaStatusEvent has unknown element " +
    ...
    //setters
    /**
    * set eventType of type AntennaStatusEventType .
    * @param  eventType to be set
    */
    public void setEventType(final AntennaStatusEventType eventType) {
    ...
    */
    ...
    //getters
    /**
    * get eventType of type AntennaStatusEventType.
    * @return  AntennaStatusEventType
    */
    public AntennaStatusEventType getEventType() {
        return eventType;
    }
    ...
    */
    public String toString() {
        String result = "AntennaStatusEvent: ";
        result += ", eventType: ";
        result += eventType;
        result += ", antennaID: ";
        result += antennaID;
