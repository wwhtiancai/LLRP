...
See also
      .
 */
public class ModuleDepth extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(664);
    private static final Logger LOGGER = Logger.getLogger(ModuleDepth.class);
     ...
     */
    public ModuleDepth(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public ModuleDepth(Element element) throws InvalidLLRPMessageException {
        decodeXML(element);
    }
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (index == null) {
            ...
            throw new MissingParameterException(
                " index not set  for Parameter of Type ModuleDepth");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "ModuleDepth has unknown element " +
