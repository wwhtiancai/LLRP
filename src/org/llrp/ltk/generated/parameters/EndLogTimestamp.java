...
See also
      .
 */
public class EndLogTimestamp extends TLVParameter {
    public static final SignedShort TYPENUM = new SignedShort(622);
    private static final Logger LOGGER = Logger.getLogger(EndLogTimestamp.class);
    protected UnsignedLong microseconds;

    /**
     * empty constructor to create new parameter.
     */
    public EndLogTimestamp() {
    }
     ...
     */
    public EndLogTimestamp(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public EndLogTimestamp(Element element) throws InvalidLLRPMessageException {
        decodeXML(element);
    }
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (microseconds == null) {
            ...
            throw new MissingParameterException(
                " microseconds not set  for Parameter of Type EndLogTimestamp");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "EndLogTimestamp has unknown element " +
