...
See also
      .
 */
public class ClientRequestSpec extends TLVParameter implements OpSpec {
    public static final SignedShort TYPENUM = new SignedShort(456);
    private static final Logger LOGGER = Logger.getLogger(ClientRequestSpec.class);
    protected UnsignedShort opSpecID;

    /**
     * empty constructor to create new parameter.
     */
    public ClientRequestSpec() {
    }
     ...
     */
    public ClientRequestSpec(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public ClientRequestSpec(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (opSpecID == null) {
            ...
            throw new MissingParameterException(
                " opSpecID not set  for Parameter of Type ClientRequestSpec");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "ClientRequestSpec has unknown element " +
    ...
    */
    public String toString() {
        String result = "ClientRequestSpec: ";
        result += ", opSpecID: ";
        result += opSpecID;
