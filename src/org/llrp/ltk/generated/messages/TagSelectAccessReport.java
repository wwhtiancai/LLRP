 ...
 */
public class TagSelectAccessReport extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(500);
    private static final Logger LOGGER = Logger.getLogger(TagSelectAccessReport.class);
     ...
     */
    public TagSelectAccessReport(final LLRPBitList list)
     ...
     */
    public TagSelectAccessReport(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public TagSelectAccessReport(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
...
//            Element root = new Element("TagSelectAccessReport", ns);
            	Element root = new Element("TagSelectAccessReport");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if ((tempList == null) || tempList.isEmpty()) {
                LOGGER.info(
                    "TagSelectAccessReport misses optional parameter of type tagReportDataList");
            } else {
            ...
            if (root.getChildren().size() > 0) {
                String message = "TagSelectAccessReport has unknown element " +
