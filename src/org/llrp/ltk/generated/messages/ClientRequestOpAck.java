...
import org.llrp.ltk.generated.parameters.ClientRequestAck;
 ...
 */
public class ClientRequestOpAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(591);
    private static final Logger LOGGER = Logger.getLogger(ClientRequestOpAck.class);
    public static final String RESPONSETYPE = "";
    protected ClientRequestAck clientRequestAck;

    /**
     * empty constructor to create new message
     * with LLRP version set to 1.0 (0x1).
     */
    public ClientRequestOpAck() {
     ...
     */
    public ClientRequestOpAck(final LLRPBitList list)
     ...
     */
    public ClientRequestOpAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ClientRequestOpAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (clientRequestAck == null) {
            // single parameter, may not be null
            LOGGER.warn(" clientRequestAck not set");
            throw new InvalidLLRPMessageException(" clientRequestAck not set");
        } else {
            resultBits.append(clientRequestAck.encodeBinary());
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ClientRequestOpAck", ns);
            //	Element root = new Element("ClientRequestOpAck");
            ...
            //parameters
            if (clientRequestAck == null) {
                LOGGER.info("clientRequestAck not set");
                throw new MissingParameterException("clientRequestAck not set");
            } else {
                root.addContent(clientRequestAck.encodeXML(
                        clientRequestAck.getClass().getSimpleName(), ns));
            }
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "ClientRequestOpAck misses non optional parameter of type ClientRequestAck");
        ...
        if (binary.get(position)) {
            ...
            tempLength = clientRequestAck.length();
        }

        if ((type != null) && type.equals(ClientRequestAck.TYPENUM)) {
            clientRequestAck = new ClientRequestAck(binary.subList(position,
                        tempLength));
            position += tempLength;
            LOGGER.debug(
                " clientRequestAck is instantiated with ClientRequestAck with length" +
                tempLength);
        } else {
            LOGGER.warn(
                "ClientRequestOpAck misses non optional parameter of type ClientRequestAck");
    ...
    */
    public void decodeXML(final Document document)
        ...
        try {
            ...
            temp = root.getChild("ClientRequestAck", ns);

            if (temp != null) {
                clientRequestAck = new ClientRequestAck(temp);
                LOGGER.info(
                    "setting parameter clientRequestAck for parameter ClientRequestOpAck");
            } else {
                LOGGER.warn(
                    "ClientRequestOpAck misses non optional parameter of type clientRequestAck");
            ...
            root.removeChild("ClientRequestAck", ns);

            if (root.getChildren().size() > 0) {
                String message = "ClientRequestOpAck has unknown element " +
    ...
    /**
    * set clientRequestAck of type ClientRequestAck.
    * @param  clientRequestAck to be set
    */
    public void setClientRequestAck(final ClientRequestAck clientRequestAck) {
        this.clientRequestAck = clientRequestAck;
    }
    ...
    /**
    * get clientRequestAck of type ClientRequestAck .
    * @return  ClientRequestAck
    */
    public ClientRequestAck getClientRequestAck() {
        return clientRequestAck;
    }
