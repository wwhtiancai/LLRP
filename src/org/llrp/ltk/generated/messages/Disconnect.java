 ...
 */
public class Disconnect extends LLRPMessage {
     ...
     */
    public Disconnect(final LLRPBitList list)
     ...
     */
    public Disconnect(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public Disconnect(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("Disconnect", ns);
            //	Element root = new Element("Disconnect");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "Disconnect has unknown element " +
