 ...
 */
public class DeleteAccessSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(452);
    private static final Logger LOGGER = Logger.getLogger(DeleteAccessSpec.class);
    public static final String RESPONSETYPE = "DeleteAccessSpecAck";
     ...
     */
    public DeleteAccessSpec(final LLRPBitList list)
     ...
     */
    public DeleteAccessSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DeleteAccessSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (accessSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " accessSpecID not set  for Parameter of Type DeleteAccessSpec");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DeleteAccessSpec", ns);
            //	Element root = new Element("DeleteAccessSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DeleteAccessSpec has unknown element " +
