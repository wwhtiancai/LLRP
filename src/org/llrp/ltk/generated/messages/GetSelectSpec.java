 ...
 */
public class GetSelectSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(412);
    private static final Logger LOGGER = Logger.getLogger(GetSelectSpec.class);
    public static final String RESPONSETYPE = "GetSelectSpecAck";

    /**
     * empty constructor to create new message
     * with LLRP version set to 1.0 (0x1).
     */
    public GetSelectSpec() {
     ...
     */
    public GetSelectSpec(final LLRPBitList list)
     ...
     */
    public GetSelectSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public GetSelectSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("GetSelectSpec", ns);
            //	Element root = new Element("GetSelectSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "GetSelectSpec has unknown element " +
