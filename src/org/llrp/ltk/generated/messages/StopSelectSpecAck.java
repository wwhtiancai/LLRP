 ...
 */
public class StopSelectSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(407);
    private static final Logger LOGGER = Logger.getLogger(StopSelectSpecAck.class);
     ...
     */
    public StopSelectSpecAck(final LLRPBitList list)
     ...
     */
    public StopSelectSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public StopSelectSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("StopSelectSpecAck", ns);
            //	Element root = new Element("StopSelectSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "StopSelectSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter StopSelectSpecAck");
            } else {
                LOGGER.warn(
                    "StopSelectSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "StopSelectSpecAck has unknown element " +
