...
import org.llrp.ltk.generated.parameters.VersionDownload;
 ...
 */
public class SetVersion extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(702);
    private static final Logger LOGGER = Logger.getLogger(SetVersion.class);
    public static final String RESPONSETYPE = "SetVersionAck";
    protected VersionType verType;
    protected VersionDownload versionDownload;
     ...
     */
    public SetVersion(final LLRPBitList list)
     ...
     */
    public SetVersion(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public SetVersion(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (verType == null) {
            ...
            throw new InvalidLLRPMessageException(
                " verType not set  for Parameter of Type SetVersion");
        }
        ...
        if (versionDownload == null) {
            ...
            LOGGER.warn(" versionDownload not set");
            throw new InvalidLLRPMessageException(" versionDownload not set");
        } else {
            resultBits.append(versionDownload.encodeBinary());
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("SetVersion", ns);
            //	Element root = new Element("SetVersion");
            ...
            //parameters
            if (versionDownload == null) {
                LOGGER.info("versionDownload not set");
                throw new MissingParameterException("versionDownload not set");
            } else {
                root.addContent(versionDownload.encodeXML(
                        versionDownload.getClass().getSimpleName(), ns));
            }
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "SetVersion misses non optional parameter of type VersionDownload");
            throw new InvalidLLRPMessageException(
                "SetVersion misses non optional parameter of type VersionDownload");
        }
        ...
        if (binary.get(position)) {
            ...
            tempLength = versionDownload.length();
        }

        if ((type != null) && type.equals(VersionDownload.TYPENUM)) {
            versionDownload = new VersionDownload(binary.subList(position,
                        tempLength));
            position += tempLength;
            LOGGER.debug(
                " versionDownload is instantiated with VersionDownload with length" +
                tempLength);
        } else {
            LOGGER.warn(
                "SetVersion misses non optional parameter of type VersionDownload");
    ...
    */
    public void decodeXML(final Document document)
        ...
        try {
            ...
            temp = root.getChild("VersionDownload", ns);

            if (temp != null) {
                versionDownload = new VersionDownload(temp);
                LOGGER.info(
                    "setting parameter versionDownload for parameter SetVersion");
            } else {
                LOGGER.warn(
                    "SetVersion misses non optional parameter of type versionDownload");
                throw new MissingParameterException(
            ...
            root.removeChild("VersionDownload", ns);

            if (root.getChildren().size() > 0) {
                String message = "SetVersion has unknown element " +
    ...
    */
    ...
    /**
    * set versionDownload of type VersionDownload.
    * @param  versionDownload to be set
    */
    public void setVersionDownload(final VersionDownload versionDownload) {
    ...
    */
    ...
    /**
    * get versionDownload of type VersionDownload .
    * @return  VersionDownload
    */
    public VersionDownload getVersionDownload() {
        return versionDownload;
    }
