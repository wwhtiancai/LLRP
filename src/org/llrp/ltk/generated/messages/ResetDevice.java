 ...
 */
public class ResetDevice extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(760);
    private static final Logger LOGGER = Logger.getLogger(ResetDevice.class);
    public static final String RESPONSETYPE = "ResetDeviceAck";
     ...
     */
    public ResetDevice(final LLRPBitList list)
     ...
     */
    public ResetDevice(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ResetDevice(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ResetDevice", ns);
            //	Element root = new Element("ResetDevice");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "ResetDevice has unknown element " +
