 ...
 */
public class SetDeviceConfigAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(663);
    private static final Logger LOGGER = Logger.getLogger(SetDeviceConfigAck.class);
     ...
     */
    public SetDeviceConfigAck(final LLRPBitList list)
     ...
     */
    public SetDeviceConfigAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public SetDeviceConfigAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("SetDeviceConfigAck", ns);
            //	Element root = new Element("SetDeviceConfigAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "SetDeviceConfigAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter SetDeviceConfigAck");
            } else {
                LOGGER.warn(
                    "SetDeviceConfigAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "SetDeviceConfigAck has unknown element " +
