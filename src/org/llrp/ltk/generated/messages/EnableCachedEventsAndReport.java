 ...
 */
public class EnableCachedEventsAndReport extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(580);
    private static final Logger LOGGER = Logger.getLogger(EnableCachedEventsAndReport.class);
     ...
     */
    public EnableCachedEventsAndReport() {
     ...
     */
    public EnableCachedEventsAndReport(final LLRPBitList list)
     ...
     */
    public EnableCachedEventsAndReport(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public EnableCachedEventsAndReport(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("EnableCachedEventsAndReport", ns);
            //	Element root = new Element("EnableCachedEventsAndReport");
    ...
    */
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "EnableCachedEventsAndReport has unknown element " +
    ...
    public String getName() {
        return "EnableCachedEventsAndReport";
    }
