 ...
 */
public class TagLogCount extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(624);
    private static final Logger LOGGER = Logger.getLogger(TagLogCount.class);
     ...
     */
    public TagLogCount(final LLRPBitList list)
     ...
     */
    public TagLogCount(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public TagLogCount(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("TagLogCount", ns);
            //	Element root = new Element("TagLogCount");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "TagLogCount has unknown element " +
