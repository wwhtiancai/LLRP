 ...
 */
public class DeviceBindingResultNotification extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(604);
    private static final Logger LOGGER = Logger.getLogger(DeviceBindingResultNotification.class);
     ...
     */
    public DeviceBindingResultNotification() {
     ...
     */
    public DeviceBindingResultNotification(final LLRPBitList list)
     ...
     */
    public DeviceBindingResultNotification(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DeviceBindingResultNotification(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DeviceBindingResultNotification", ns);
            //	Element root = new Element("DeviceBindingResultNotification");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "DeviceBindingResultNotification misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter DeviceBindingResultNotification");
            } else {
                LOGGER.warn(
                    "DeviceBindingResultNotification misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "DeviceBindingResultNotification has unknown element " +
    ...
    */
    ...
    public String getName() {
        return "DeviceBindingResultNotification";
    }
