 ...
 */
public class ClearDeviceLog extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(642);
    private static final Logger LOGGER = Logger.getLogger(ClearDeviceLog.class);
    public static final String RESPONSETYPE = "ClearDeviceLogAck";

    /**
     * empty constructor to create new message
     * with LLRP version set to 1.0 (0x1).
     */
    public ClearDeviceLog() {
     ...
     */
    public ClearDeviceLog(final LLRPBitList list)
     ...
     */
    public ClearDeviceLog(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ClearDeviceLog(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ClearDeviceLog", ns);
            //	Element root = new Element("ClearDeviceLog");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "ClearDeviceLog has unknown element " +
