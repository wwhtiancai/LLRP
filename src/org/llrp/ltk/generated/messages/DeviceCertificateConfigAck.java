 ...
 */
public class DeviceCertificateConfigAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(603);
    private static final Logger LOGGER = Logger.getLogger(DeviceCertificateConfigAck.class);
     ...
     */
    public DeviceCertificateConfigAck() {
     ...
     */
    public DeviceCertificateConfigAck(final LLRPBitList list)
     ...
     */
    public DeviceCertificateConfigAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DeviceCertificateConfigAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DeviceCertificateConfigAck", ns);
            //	Element root = new Element("DeviceCertificateConfigAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "DeviceCertificateConfigAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter DeviceCertificateConfigAck");
            } else {
                LOGGER.warn(
                    "DeviceCertificateConfigAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "DeviceCertificateConfigAck has unknown element " +
    ...
    */
    ...
    public String getName() {
        return "DeviceCertificateConfigAck";
    }
