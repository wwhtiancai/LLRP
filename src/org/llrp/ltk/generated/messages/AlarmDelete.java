 ...
 */
public class AlarmDelete extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(722);
    private static final Logger LOGGER = Logger.getLogger(AlarmDelete.class);
     ...
     */
    public AlarmDelete(final LLRPBitList list)
     ...
     */
    public AlarmDelete(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public AlarmDelete(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (alarmID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " alarmID not set  for Parameter of Type AlarmDelete");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("AlarmDelete", ns);
            //	Element root = new Element("AlarmDelete");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "AlarmDelete has unknown element " +
