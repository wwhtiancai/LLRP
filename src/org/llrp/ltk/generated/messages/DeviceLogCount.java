 ...
 */
public class DeviceLogCount extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(644);
    private static final Logger LOGGER = Logger.getLogger(DeviceLogCount.class);
     ...
     */
    public DeviceLogCount(final LLRPBitList list)
     ...
     */
    public DeviceLogCount(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DeviceLogCount(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DeviceLogCount", ns);
            //	Element root = new Element("DeviceLogCount");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DeviceLogCount has unknown element " +
