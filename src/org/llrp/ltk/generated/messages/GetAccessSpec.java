 ...
 */
public class GetAccessSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(458);
    private static final Logger LOGGER = Logger.getLogger(GetAccessSpec.class);
    public static final String RESPONSETYPE = "GetAccessSpecAck";

    /**
     * empty constructor to create new message
     * with LLRP version set to 1.0 (0x1).
     */
    public GetAccessSpec() {
     ...
     */
    public GetAccessSpec(final LLRPBitList list)
     ...
     */
    public GetAccessSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public GetAccessSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("GetAccessSpec", ns);
            //	Element root = new Element("GetAccessSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "GetAccessSpec has unknown element " +
