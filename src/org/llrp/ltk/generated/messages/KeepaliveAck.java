 ...
 */
public class KeepaliveAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(301);
    private static final Logger LOGGER = Logger.getLogger(KeepaliveAck.class);
     ...
     */
    public KeepaliveAck(final LLRPBitList list)
     ...
     */
    public KeepaliveAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public KeepaliveAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("KeepaliveAck", ns);
            //	Element root = new Element("KeepaliveAck");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "KeepaliveAck has unknown element " +
