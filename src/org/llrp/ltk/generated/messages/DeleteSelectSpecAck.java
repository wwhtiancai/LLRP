 ...
 */
public class DeleteSelectSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(403);
    private static final Logger LOGGER = Logger.getLogger(DeleteSelectSpecAck.class);
     ...
     */
    public DeleteSelectSpecAck(final LLRPBitList list)
     ...
     */
    public DeleteSelectSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DeleteSelectSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DeleteSelectSpecAck", ns);
            //	Element root = new Element("DeleteSelectSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "DeleteSelectSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter DeleteSelectSpecAck");
            } else {
                LOGGER.warn(
                    "DeleteSelectSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "DeleteSelectSpecAck has unknown element " +
