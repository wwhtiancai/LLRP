 ...
 */
public class EnableSelectSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(408);
    private static final Logger LOGGER = Logger.getLogger(EnableSelectSpec.class);
    public static final String RESPONSETYPE = "EnableSelectSpecAck";
     ...
     */
    public EnableSelectSpec(final LLRPBitList list)
     ...
     */
    public EnableSelectSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public EnableSelectSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (selectSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " selectSpecID not set  for Parameter of Type EnableSelectSpec");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("EnableSelectSpec", ns);
            //	Element root = new Element("EnableSelectSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "EnableSelectSpec has unknown element " +
