 ...
 */
public class AddAccessSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(451);
    private static final Logger LOGGER = Logger.getLogger(AddAccessSpecAck.class);
     ...
     */
    public AddAccessSpecAck(final LLRPBitList list)
     ...
     */
    public AddAccessSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public AddAccessSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("AddAccessSpecAck", ns);
            //	Element root = new Element("AddAccessSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "AddAccessSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter AddAccessSpecAck");
            } else {
                LOGGER.warn(
                    "AddAccessSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "AddAccessSpecAck has unknown element " +
