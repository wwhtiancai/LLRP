 ...
 */
public class SetDeviceConfig extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(662);
    private static final Logger LOGGER = Logger.getLogger(SetDeviceConfig.class);
    public static final String RESPONSETYPE = "SetDeviceConfigAck";
     ...
     */
    public SetDeviceConfig(final LLRPBitList list)
     ...
     */
    public SetDeviceConfig(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public SetDeviceConfig(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (resetToFactoryDefault == null) {
            ...
            throw new InvalidLLRPMessageException(
                " resetToFactoryDefault not set  for Parameter of Type SetDeviceConfig");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("SetDeviceConfig", ns);
            //	Element root = new Element("SetDeviceConfig");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type Identification");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type DeviceEventNotificationSpec");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type AlarmConfiguration");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type ModuleDepth");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type SelectReportSpec");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type AccessReportSpec");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type CommunicationConfiguration");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type LocationConfiguration");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "SetDeviceConfig misses optional parameter of type SecurityModuleConfiguration");
        }
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter identification for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type identification");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter deviceEventNotificationSpec for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type deviceEventNotificationSpec");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter alarmConfiguration for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type alarmConfiguration");
            }
            ...
            if ((tempList == null) || tempList.isEmpty()) {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type antennaConfigurationList");
            } else {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter moduleDepth for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type moduleDepth");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter selectReportSpec for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type selectReportSpec");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter accessReportSpec for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type accessReportSpec");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter communicationConfiguration for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type communicationConfiguration");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter locationConfiguration for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type locationConfiguration");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter securityModuleConfiguration for parameter SetDeviceConfig");
            } else {
                LOGGER.info(
                    "SetDeviceConfig misses optional parameter of type securityModuleConfiguration");
            }
            ...
            if (root.getChildren().size() > 0) {
                String message = "SetDeviceConfig has unknown element " +
