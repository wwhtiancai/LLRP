 ...
 */
public class DisableSelectSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(411);
    private static final Logger LOGGER = Logger.getLogger(DisableSelectSpecAck.class);
     ...
     */
    public DisableSelectSpecAck(final LLRPBitList list)
     ...
     */
    public DisableSelectSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DisableSelectSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DisableSelectSpecAck", ns);
            //	Element root = new Element("DisableSelectSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "DisableSelectSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter DisableSelectSpecAck");
            } else {
                LOGGER.warn(
                    "DisableSelectSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "DisableSelectSpecAck has unknown element " +
