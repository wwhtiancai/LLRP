 ...
 */
public class StartSelectSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(405);
    private static final Logger LOGGER = Logger.getLogger(StartSelectSpecAck.class);
     ...
     */
    public StartSelectSpecAck(final LLRPBitList list)
     ...
     */
    public StartSelectSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public StartSelectSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("StartSelectSpecAck", ns);
            //	Element root = new Element("StartSelectSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "StartSelectSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter StartSelectSpecAck");
            } else {
                LOGGER.warn(
                    "StartSelectSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "StartSelectSpecAck has unknown element " +
