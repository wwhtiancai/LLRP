 ...
 */
public class GetAccessSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(459);
    private static final Logger LOGGER = Logger.getLogger(GetAccessSpecAck.class);
     ...
     */
    public GetAccessSpecAck(final LLRPBitList list)
     ...
     */
    public GetAccessSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public GetAccessSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("GetAccessSpecAck", ns);
            //	Element root = new Element("GetAccessSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "GetAccessSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter GetAccessSpecAck");
            } else {
                LOGGER.warn(
                    "GetAccessSpecAck misses non optional parameter of type status");
            ...
            if ((tempList == null) || tempList.isEmpty()) {
                LOGGER.info(
                    "GetAccessSpecAck misses optional parameter of type accessSpecList");
            } else {
            ...
            if (root.getChildren().size() > 0) {
                String message = "GetAccessSpecAck has unknown element " +
