 ...
 */
public class StartSelectSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(404);
    private static final Logger LOGGER = Logger.getLogger(StartSelectSpec.class);
    public static final String RESPONSETYPE = "StartSelectSpecAck";
     ...
     */
    public StartSelectSpec(final LLRPBitList list)
     ...
     */
    public StartSelectSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public StartSelectSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (selectSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " selectSpecID not set  for Parameter of Type StartSelectSpec");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("StartSelectSpec", ns);
            //	Element root = new Element("StartSelectSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "StartSelectSpec has unknown element " +
