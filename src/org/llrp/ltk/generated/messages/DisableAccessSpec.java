 ...
 */
public class DisableAccessSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(456);
    private static final Logger LOGGER = Logger.getLogger(DisableAccessSpec.class);
    public static final String RESPONSETYPE = "DisableAccessSpecAck";
     ...
     */
    public DisableAccessSpec(final LLRPBitList list)
     ...
     */
    public DisableAccessSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DisableAccessSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (accessSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " accessSpecID not set  for Parameter of Type DisableAccessSpec");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DisableAccessSpec", ns);
            //	Element root = new Element("DisableAccessSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DisableAccessSpec has unknown element " +
