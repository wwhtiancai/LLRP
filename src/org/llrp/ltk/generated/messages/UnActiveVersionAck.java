 ...
 */
public class UnActiveVersionAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(707);
    private static final Logger LOGGER = Logger.getLogger(UnActiveVersionAck.class);
     ...
     */
    public UnActiveVersionAck(final LLRPBitList list)
     ...
     */
    public UnActiveVersionAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public UnActiveVersionAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("UnActiveVersionAck", ns);
            //	Element root = new Element("UnActiveVersionAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "UnActiveVersionAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter UnActiveVersionAck");
            } else {
                LOGGER.warn(
                    "UnActiveVersionAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "UnActiveVersionAck has unknown element " +
