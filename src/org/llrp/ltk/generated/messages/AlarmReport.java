...
import org.llrp.ltk.generated.parameters.AlarmReportInfo;
 ...
 */
public class AlarmReport extends LLRPMessage {
     ...
     */
    public AlarmReport(final LLRPBitList list)
     ...
     */
    public AlarmReport(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public AlarmReport(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (alarmID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " alarmID not set  for Parameter of Type AlarmReport");
        }

        resultBits.append(alarmID.encodeBinary());

        if (alarmReportInfo == null) {
            // single parameter, may not be null
            LOGGER.warn(" alarmReportInfo not set");
            throw new InvalidLLRPMessageException(" alarmReportInfo not set");
        } else {
            resultBits.append(alarmReportInfo.encodeBinary());
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("AlarmReport", ns);
            //	Element root = new Element("AlarmReport");
            ...
            //parameters
            if (alarmReportInfo == null) {
                LOGGER.info("alarmReportInfo not set");
                throw new MissingParameterException("alarmReportInfo not set");
            } else {
                root.addContent(alarmReportInfo.encodeXML(
                        alarmReportInfo.getClass().getSimpleName(), ns));
            }
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "AlarmReport misses non optional parameter of type AlarmReportInfo");
            throw new InvalidLLRPMessageException(
                "AlarmReport misses non optional parameter of type AlarmReportInfo");
        }
        ...
        if (binary.get(position)) {
            ...
            tempLength = alarmReportInfo.length();
        }

        if ((type != null) && type.equals(AlarmReportInfo.TYPENUM)) {
            alarmReportInfo = new AlarmReportInfo(binary.subList(position,
                        tempLength));
            position += tempLength;
            LOGGER.debug(
                " alarmReportInfo is instantiated with AlarmReportInfo with length" +
                tempLength);
        } else {
            LOGGER.warn(
                "AlarmReport misses non optional parameter of type AlarmReportInfo");
    ...
    */
    public void decodeXML(final Document document)
        ...
        try {
            ...
            temp = root.getChild("AlarmReportInfo", ns);

            if (temp != null) {
                alarmReportInfo = new AlarmReportInfo(temp);
                LOGGER.info(
                    "setting parameter alarmReportInfo for parameter AlarmReport");
            } else {
                LOGGER.warn(
                    "AlarmReport misses non optional parameter of type alarmReportInfo");
                throw new MissingParameterException(
            ...
            root.removeChild("AlarmReportInfo", ns);

            if (root.getChildren().size() > 0) {
                String message = "AlarmReport has unknown element " +
    ...
    */
    ...
    /**
    * set alarmReportInfo of type AlarmReportInfo.
    * @param  alarmReportInfo to be set
    */
    public void setAlarmReportInfo(final AlarmReportInfo alarmReportInfo) {
        this.alarmReportInfo = alarmReportInfo;
    }
    ...
    */
    ...
    /**
    * get alarmReportInfo of type AlarmReportInfo .
