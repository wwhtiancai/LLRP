 ...
 */
public class DisableSelectSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(410);
    private static final Logger LOGGER = Logger.getLogger(DisableSelectSpec.class);
    public static final String RESPONSETYPE = "DisableSelectSpecAck";
     ...
     */
    public DisableSelectSpec(final LLRPBitList list)
     ...
     */
    public DisableSelectSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DisableSelectSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (selectSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " selectSpecID not set  for Parameter of Type DisableSelectSpec");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DisableSelectSpec", ns);
            //	Element root = new Element("DisableSelectSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DisableSelectSpec has unknown element " +
