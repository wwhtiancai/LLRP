 ...
 */
public class DisableAccessSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(457);
    private static final Logger LOGGER = Logger.getLogger(DisableAccessSpecAck.class);
     ...
     */
    public DisableAccessSpecAck(final LLRPBitList list)
     ...
     */
    public DisableAccessSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DisableAccessSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DisableAccessSpecAck", ns);
            //	Element root = new Element("DisableAccessSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "DisableAccessSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter DisableAccessSpecAck");
            } else {
                LOGGER.warn(
                    "DisableAccessSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "DisableAccessSpecAck has unknown element " +
