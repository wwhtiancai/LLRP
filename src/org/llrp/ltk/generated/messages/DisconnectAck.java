 ...
 */
public class DisconnectAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(304);
    private static final Logger LOGGER = Logger.getLogger(DisconnectAck.class);
     ...
     */
    public DisconnectAck(final LLRPBitList list)
     ...
     */
    public DisconnectAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DisconnectAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DisconnectAck", ns);
            //	Element root = new Element("DisconnectAck");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DisconnectAck has unknown element " +
