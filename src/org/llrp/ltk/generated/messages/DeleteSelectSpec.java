 ...
 */
public class DeleteSelectSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(402);
    private static final Logger LOGGER = Logger.getLogger(DeleteSelectSpec.class);
    public static final String RESPONSETYPE = "DeleteSelectSpecAck";
     ...
     */
    public DeleteSelectSpec(final LLRPBitList list)
     ...
     */
    public DeleteSelectSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DeleteSelectSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (selectSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " selectSpecID not set  for Parameter of Type DeleteSelectSpec");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DeleteSelectSpec", ns);
            //	Element root = new Element("DeleteSelectSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DeleteSelectSpec has unknown element " +
