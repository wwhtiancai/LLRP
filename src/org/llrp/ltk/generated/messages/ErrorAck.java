 ...
 */
public class ErrorAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(305);
    private static final Logger LOGGER = Logger.getLogger(ErrorAck.class);
     ...
     */
    public ErrorAck(final LLRPBitList list) throws InvalidLLRPMessageException {
     ...
     */
    public ErrorAck(final byte[] byteArray) throws InvalidLLRPMessageException {
    ...
    */
    public ErrorAck(final Document document) throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ErrorAck", ns);
            //	Element root = new Element("ErrorAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn("ErrorAck misses non optional parameter of type Status");
            throw new InvalidLLRPMessageException(
                "ErrorAck misses non optional parameter of type Status");
        }
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info("setting parameter status for parameter ErrorAck");
            } else {
                LOGGER.warn(
                    "ErrorAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "ErrorAck has unknown element " +
