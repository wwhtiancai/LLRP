 ...
 */
public class EnableSelectSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(409);
    private static final Logger LOGGER = Logger.getLogger(EnableSelectSpecAck.class);
     ...
     */
    public EnableSelectSpecAck(final LLRPBitList list)
     ...
     */
    public EnableSelectSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public EnableSelectSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("EnableSelectSpecAck", ns);
            //	Element root = new Element("EnableSelectSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "EnableSelectSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter EnableSelectSpecAck");
            } else {
                LOGGER.warn(
                    "EnableSelectSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "EnableSelectSpecAck has unknown element " +
