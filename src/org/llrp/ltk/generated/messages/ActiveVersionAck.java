 ...
 */
public class ActiveVersionAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(705);
    private static final Logger LOGGER = Logger.getLogger(ActiveVersionAck.class);
     ...
     */
    public ActiveVersionAck(final LLRPBitList list)
     ...
     */
    public ActiveVersionAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ActiveVersionAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ActiveVersionAck", ns);
            //	Element root = new Element("ActiveVersionAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "ActiveVersionAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter ActiveVersionAck");
            } else {
                LOGGER.warn(
                    "ActiveVersionAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "ActiveVersionAck has unknown element " +
