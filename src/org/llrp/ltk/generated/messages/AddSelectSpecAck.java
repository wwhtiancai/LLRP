 ...
 */
public class AddSelectSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(401);
    private static final Logger LOGGER = Logger.getLogger(AddSelectSpecAck.class);
     ...
     */
    public AddSelectSpecAck(final LLRPBitList list)
     ...
     */
    public AddSelectSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public AddSelectSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("AddSelectSpecAck", ns);
            //	Element root = new Element("AddSelectSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "AddSelectSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter AddSelectSpecAck");
            } else {
                LOGGER.warn(
                    "AddSelectSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "AddSelectSpecAck has unknown element " +
