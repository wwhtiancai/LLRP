 ...
 */
public class UploadTagLogConfirm extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(626);
    private static final Logger LOGGER = Logger.getLogger(UploadTagLogConfirm.class);
     ...
     */
    public UploadTagLogConfirm(final LLRPBitList list)
     ...
     */
    public UploadTagLogConfirm(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public UploadTagLogConfirm(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (sequenceId == null) {
            ...
            throw new InvalidLLRPMessageException(
                " sequenceId not set  for Parameter of Type UploadTagLogConfirm");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("UploadTagLogConfirm", ns);
            //	Element root = new Element("UploadTagLogConfirm");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "UploadTagLogConfirm has unknown element " +
