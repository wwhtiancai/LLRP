 ...
 */
public class SetVersionAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(703);
    private static final Logger LOGGER = Logger.getLogger(SetVersionAck.class);
     ...
     */
    public SetVersionAck(final LLRPBitList list)
     ...
     */
    public SetVersionAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public SetVersionAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("SetVersionAck", ns);
            //	Element root = new Element("SetVersionAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "SetVersionAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter SetVersionAck");
            } else {
                LOGGER.warn(
                    "SetVersionAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "SetVersionAck has unknown element " +
