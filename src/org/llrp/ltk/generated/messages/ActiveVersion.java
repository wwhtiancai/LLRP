 ...
 */
public class ActiveVersion extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(704);
    private static final Logger LOGGER = Logger.getLogger(ActiveVersion.class);
    public static final String RESPONSETYPE = "ActiveVersionAck";
     ...
     */
    public ActiveVersion(final LLRPBitList list)
     ...
     */
    public ActiveVersion(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ActiveVersion(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (verType == null) {
            ...
            throw new InvalidLLRPMessageException(
                " verType not set  for Parameter of Type ActiveVersion");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ActiveVersion", ns);
            //	Element root = new Element("ActiveVersion");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "ActiveVersion has unknown element " +
