 ...
 */
public class ResetDeviceAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(761);
    private static final Logger LOGGER = Logger.getLogger(ResetDeviceAck.class);
     ...
     */
    public ResetDeviceAck(final LLRPBitList list)
     ...
     */
    public ResetDeviceAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ResetDeviceAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ResetDeviceAck", ns);
            //	Element root = new Element("ResetDeviceAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "ResetDeviceAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter ResetDeviceAck");
            } else {
                LOGGER.warn(
                    "ResetDeviceAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "ResetDeviceAck has unknown element " +
