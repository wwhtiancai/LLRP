 ...
 */
public class DeleteAccessSpecAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(453);
    private static final Logger LOGGER = Logger.getLogger(DeleteAccessSpecAck.class);
     ...
     */
    public DeleteAccessSpecAck(final LLRPBitList list)
     ...
     */
    public DeleteAccessSpecAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DeleteAccessSpecAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DeleteAccessSpecAck", ns);
            //	Element root = new Element("DeleteAccessSpecAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "DeleteAccessSpecAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter DeleteAccessSpecAck");
            } else {
                LOGGER.warn(
                    "DeleteAccessSpecAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "DeleteAccessSpecAck has unknown element " +
