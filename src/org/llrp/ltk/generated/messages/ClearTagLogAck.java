 ...
 */
public class ClearTagLogAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(623);
    private static final Logger LOGGER = Logger.getLogger(ClearTagLogAck.class);
     ...
     */
    public ClearTagLogAck(final LLRPBitList list)
     ...
     */
    public ClearTagLogAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ClearTagLogAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ClearTagLogAck", ns);
            //	Element root = new Element("ClearTagLogAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "ClearTagLogAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter ClearTagLogAck");
            } else {
                LOGGER.warn(
                    "ClearTagLogAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "ClearTagLogAck has unknown element " +
