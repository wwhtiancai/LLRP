 ...
 */
public class ClientRequestOp extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(590);
    private static final Logger LOGGER = Logger.getLogger(ClientRequestOp.class);
     ...
     */
    public ClientRequestOp(final LLRPBitList list)
     ...
     */
    public ClientRequestOp(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ClientRequestOp(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ClientRequestOp", ns);
            //	Element root = new Element("ClientRequestOp");
            ...
            if (tagReportData == null) {
                ...
                root.addContent(tagReportData.encodeXML(
                        tagReportData.getClass().getSimpleName(), ns));
            }
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "ClientRequestOp misses non optional parameter of type TagReportData");
        ...
        if ((type != null) && type.equals(TagReportData.TYPENUM)) {
            tagReportData = new TagReportData(binary.subList(position,
                        tempLength));
            position += tempLength;
            LOGGER.debug(
                " tagReportData is instantiated with TagReportData with length" +
                tempLength);
        } else {
            LOGGER.warn(
                "ClientRequestOp misses non optional parameter of type TagReportData");
    ...
    */
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                tagReportData = new TagReportData(temp);
                LOGGER.info(
                    "setting parameter tagReportData for parameter ClientRequestOp");
            } else {
                LOGGER.warn(
                    "ClientRequestOp misses non optional parameter of type tagReportData");
            ...
            if (root.getChildren().size() > 0) {
                String message = "ClientRequestOp has unknown element " +
    ...
    /**
    * set tagReportData of type TagReportData.
    * @param  tagReportData to be set
    */
    public void setTagReportData(final TagReportData tagReportData) {
    ...
    /**
    * get tagReportData of type TagReportData .
