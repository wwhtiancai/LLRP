...
import org.llrp.ltk.generated.enumerations.UploadTagLogType;
 ...
 */
public class UploadTagLog extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(620);
    private static final Logger LOGGER = Logger.getLogger(UploadTagLog.class);
    public static final String RESPONSETYPE = "UploadTagLogAck";
    protected UploadTagLogType uploadType;
     ...
     */
    public UploadTagLog(final LLRPBitList list)
     ...
     */
    public UploadTagLog(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public UploadTagLog(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (uploadType == null) {
            ...
            throw new InvalidLLRPMessageException(
                " uploadType not set  for Parameter of Type UploadTagLog");
        }
        ...
        if (uploadCount == null) {
            ...
            throw new InvalidLLRPMessageException(
                " uploadCount not set  for Parameter of Type UploadTagLog");
        }
        ...
        if (milliseconds == null) {
            ...
            throw new InvalidLLRPMessageException(
                " milliseconds not set  for Parameter of Type UploadTagLog");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("UploadTagLog", ns);
            //	Element root = new Element("UploadTagLog");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        SignedShort type;
        int fieldCount;
        uploadType = new UploadTagLogType(binary.subList(position,
                    UploadTagLogType.length()));
        position += UploadTagLogType.length();
        ...
        try {
            ...
            LOGGER.info(
                "UploadTagLog misses optional parameter of type StartLogTimestamp");
        }
        ...
        try {
            ...
            // if an IllegalArgumentException is thrown, list was not long enough so the parameter is missing
            LOGGER.info(
                "UploadTagLog misses optional parameter of type EndLogTimestamp");
        }
    ...
    */
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                uploadType = new UploadTagLogType(temp);
            } else {
                LOGGER.warn(
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter startLogTimestamp for parameter UploadTagLog");
            } else {
                LOGGER.info(
                    "UploadTagLog misses optional parameter of type startLogTimestamp");
            }
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter endLogTimestamp for parameter UploadTagLog");
            } else {
                LOGGER.info(
                    "UploadTagLog misses optional parameter of type endLogTimestamp");
            }
            ...
            if (root.getChildren().size() > 0) {
                String message = "UploadTagLog has unknown element " +
    ...
    //setters
    /**
    * set uploadType of type UploadTagLogType .
    * @param  uploadType to be set
    */
    public void setUploadType(final UploadTagLogType uploadType) {
    ...
    */
    ...
    //getters
    /**
    * get uploadType of type UploadTagLogType.
    * @return  UploadTagLogType
    */
    public UploadTagLogType getUploadType() {
        return uploadType;
    }
