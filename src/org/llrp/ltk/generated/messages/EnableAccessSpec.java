 ...
 */
public class EnableAccessSpec extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(454);
    private static final Logger LOGGER = Logger.getLogger(EnableAccessSpec.class);
    public static final String RESPONSETYPE = "EnableAccessSpecAck";
     ...
     */
    public EnableAccessSpec(final LLRPBitList list)
     ...
     */
    public EnableAccessSpec(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public EnableAccessSpec(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (accessSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " accessSpecID not set  for Parameter of Type EnableAccessSpec");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("EnableAccessSpec", ns);
            //	Element root = new Element("EnableAccessSpec");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "EnableAccessSpec has unknown element " +
