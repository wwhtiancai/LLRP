 ...
 */
public class GetDeviceCapabilities extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(350);
    private static final Logger LOGGER = Logger.getLogger(GetDeviceCapabilities.class);
    public static final String RESPONSETYPE = "GetDeviceCapabilitiesAck";
    protected GetDeviceCapabilitiesRequestedDataType requestedData;
     ...
     */
    public GetDeviceCapabilities(final LLRPBitList list)
     ...
     */
    public GetDeviceCapabilities(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public GetDeviceCapabilities(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (requestedData == null) {
            ...
            throw new InvalidLLRPMessageException(
                " requestedData not set  for Parameter of Type GetDeviceCapabilities");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("GetDeviceCapabilities", ns);
            //	Element root = new Element("GetDeviceCapabilities");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        SignedShort type;
        int fieldCount;
        requestedData = new GetDeviceCapabilitiesRequestedDataType(binary.subList(
                    position, GetDeviceCapabilitiesRequestedDataType.length()));
        position += GetDeviceCapabilitiesRequestedDataType.length();
    }
    ...
    */
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                requestedData = new GetDeviceCapabilitiesRequestedDataType(temp);
            } else {
                LOGGER.warn(
            ...
            if (root.getChildren().size() > 0) {
                String message = "GetDeviceCapabilities has unknown element " +
    ...
    //setters
    /**
    * set requestedData of type GetDeviceCapabilitiesRequestedDataType .
    * @param  requestedData to be set
    */
    public void setRequestedData(
        final GetDeviceCapabilitiesRequestedDataType requestedData) {
    ...
    //getters
    /**
    * get requestedData of type GetDeviceCapabilitiesRequestedDataType.
    * @return  GetDeviceCapabilitiesRequestedDataType
    */
    public GetDeviceCapabilitiesRequestedDataType getRequestedData() {
