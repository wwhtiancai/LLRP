...
import org.llrp.ltk.generated.parameters.VersionInfo;
 ...
 */
public class GetVersionAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(701);
    private static final Logger LOGGER = Logger.getLogger(GetVersionAck.class);
    public static final String RESPONSETYPE = "";
    protected Status status;
    protected List<VersionInfo> versionInfoList = new LinkedList<VersionInfo>();

    /**
     * empty constructor to create new message
     * with LLRP version set to 1.0 (0x1).
     */
    public GetVersionAck() {
     ...
     */
    public GetVersionAck(final LLRPBitList list)
     ...
     */
    public GetVersionAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public GetVersionAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (versionInfoList == null) {
            ...
            LOGGER.info(" versionInfoList not set");
        } else {
            for (VersionInfo field : versionInfoList) {
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("GetVersionAck", ns);
            //	Element root = new Element("GetVersionAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "GetVersionAck misses non optional parameter of type Status");
        ...
        // list of parameters
        versionInfoList = new LinkedList<VersionInfo>();
        LOGGER.debug("decoding parameter versionInfoList ");
        ...
        while (position < binary.length()) {
            ...
            if ((type != null) && type.equals(VersionInfo.TYPENUM)) {
                //if first bit is 1 it is a TV Parameter
                if (binary.get(position)) {
                    // length can statically be determined for TV Parameters
                    tempLength = VersionInfo.length();
                }

                versionInfoList.add(new VersionInfo(binary.subList(position,
                            tempLength)));
                LOGGER.debug("adding VersionInfo to versionInfoList ");
                atLeastOnce = true;
                position += tempLength;
            }
        ...
        if (versionInfoList.isEmpty()) {
            LOGGER.info(
                "encoded message does not contain parameter for optional versionInfoList");
        }
    }
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter GetVersionAck");
            } else {
                LOGGER.warn(
                    "GetVersionAck misses non optional parameter of type status");
            ...
            versionInfoList = new LinkedList<VersionInfo>();
            tempList = root.getChildren("VersionInfo", ns);

            if ((tempList == null) || tempList.isEmpty()) {
                LOGGER.info(
                    "GetVersionAck misses optional parameter of type versionInfoList");
            } else {
                for (Element e : tempList) {
                    versionInfoList.add(new VersionInfo(e));
                    LOGGER.debug("adding VersionInfo to versionInfoList ");
                }
            }

            root.removeChildren("VersionInfo", ns);

            if (root.getChildren().size() > 0) {
                String message = "GetVersionAck has unknown element " +
    ...
    */
    ...
    /**
    * set versionInfoList of type  List &lt;VersionInfo>.
    * @param  versionInfoList to be set
    */
    public void setVersionInfoList(final List<VersionInfo> versionInfoList) {
    ...
    */
    ...
    /**
    * get versionInfoList of type List &lt;VersionInfo> .
    ...
    */
    ...
    /**
    * add element versionInfo of type VersionInfo .
    * @param  versionInfo of type VersionInfo
    */
    public void addToVersionInfoList(VersionInfo versionInfo) {
        if (this.versionInfoList == null) {
            this.versionInfoList = new LinkedList<VersionInfo>();
        }
