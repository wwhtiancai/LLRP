 ...
 */
public class CachedSelectAccessReport extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(581);
    private static final Logger LOGGER = Logger.getLogger(CachedSelectAccessReport.class);
     ...
     */
    public CachedSelectAccessReport() {
     ...
     */
    public CachedSelectAccessReport(final LLRPBitList list)
     ...
     */
    public CachedSelectAccessReport(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public CachedSelectAccessReport(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (sequenceID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " sequenceID not set  for Parameter of Type CachedSelectAccessReport");
        }
        ...
        if (isLastedFrame == null) {
            ...
            throw new InvalidLLRPMessageException(
                " isLastedFrame not set  for Parameter of Type CachedSelectAccessReport");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("CachedSelectAccessReport", ns);
            //	Element root = new Element("CachedSelectAccessReport");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "CachedSelectAccessReport misses non optional parameter of type Status");
            throw new InvalidLLRPMessageException(
                "CachedSelectAccessReport misses non optional parameter of type Status");
        }
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter CachedSelectAccessReport");
            } else {
                LOGGER.warn(
                    "CachedSelectAccessReport misses non optional parameter of type status");
                throw new MissingParameterException(
            ...
            if ((tempList == null) || tempList.isEmpty()) {
                LOGGER.info(
                    "CachedSelectAccessReport misses optional parameter of type tagReportDataList");
            } else {
            ...
            if (root.getChildren().size() > 0) {
                String message = "CachedSelectAccessReport has unknown element " +
    ...
    */
    ...
    public String getName() {
        return "CachedSelectAccessReport";
    }
