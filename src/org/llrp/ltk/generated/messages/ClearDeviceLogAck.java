 ...
 */
public class ClearDeviceLogAck extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(643);
    private static final Logger LOGGER = Logger.getLogger(ClearDeviceLogAck.class);
     ...
     */
    public ClearDeviceLogAck(final LLRPBitList list)
     ...
     */
    public ClearDeviceLogAck(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ClearDeviceLogAck(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ClearDeviceLogAck", ns);
            //	Element root = new Element("ClearDeviceLogAck");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "ClearDeviceLogAck misses non optional parameter of type Status");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter status for parameter ClearDeviceLogAck");
            } else {
                LOGGER.warn(
                    "ClearDeviceLogAck misses non optional parameter of type status");
            ...
            if (root.getChildren().size() > 0) {
                String message = "ClearDeviceLogAck has unknown element " +
