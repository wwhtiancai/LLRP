...
public abstract class LLRPConnection {
	...
	protected BitList devicesn = new BitList(LLRPMessage.DEVICESNLENGTH);
	...
	protected void checkLLRPConnectionAttemptStatus(long timeout)throws LLRPConnectionAttemptFailedException{
		try{
			...
			if(connectionAttemptEvent != null){
				ConnectionAttemptEventStatusType status = connectionAttemptEvent.getConnectionStatus();
	...
	public void setDevicesn(BitList devicesn) {
